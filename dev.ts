...
const WORDPRESS_URL = "https://lightwithdrawn.dev";
const WORDPRESS_ALIASES = ["https://lightwithdrawn.dev", "https://the-light-withdrawn.ddev.site"];
...
const watchDirs = [".", "components", "templates", "js"];
...
const server = Bun.serve({
  ...
  fetch(req, server) {
    ...
    const themePath = "/wp-content/themes/the-light-withdrawn/";
