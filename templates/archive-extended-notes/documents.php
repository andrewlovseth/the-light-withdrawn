...
<section class="documents appendices | content-grid">
    ...
    <div class="documents__list notes__list">
        ...
        <?php if(have_rows('extended_notes_table_of_contents', 'options')): while(have_rows('extended_notes_table_of_contents', 'options')) : the_row(); ?>
            ...
            <?php get_template_part('templates/archive-extended-notes/single-note'); ?>
