            ...
            <div class="video__pagination">
                <div class="video__prev">
                    <a href="<?php echo esc_url($prev_post_link); ?>" class="video__pagination-link">
                        <svg width="14" height="25" viewBox="0 0 29 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M27.8462 49L2 25L27.8462 1" stroke="#8ACAD7" stroke-width="4" stroke-linecap="round"/>
                        </svg>      
                    </a>
                </div>
                ...
                <div class="video__next">
                    <a href="<?php echo esc_url($next_post_link); ?>" class="video__pagination-link">
                        <svg width="14" height="25" viewBox="0 0 29 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1.00004 1L26.8462 25L1.00004 49" stroke="#8ACAD7" stroke-width="4" stroke-linecap="round"/>
                        </svg>            
                    </a>
                </div>
            </div>
