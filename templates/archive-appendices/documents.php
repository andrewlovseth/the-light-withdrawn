<?php
    ...
    $combined_pdf = $appendices['combined_pdf'];
    $document_list = $appendices['document_list'];
    ...
    <div class="documents__list appendices__list">
        ...
        <form id="batch-download-form" method="post" action="<?php echo admin_url('admin-ajax.php'); ?>">
            ...
            <?php if( $document_list ): ?>
                <?php foreach( $document_list as $d ): ?>
                    <div class="document-item">
                        <input type="checkbox" name="selected_docs[]" value="<?php echo $d->ID; ?>" id="doc-<?php echo $d->ID; ?>">
                        <label for="doc-<?php echo $d->ID; ?>">
                            <?php
                                $args = ['id' => $d->ID];
                                get_template_part('templates/archive-appendices/document', null, $args);
                            ?>
                        </label>
                    </div>
                <?php endforeach; ?>
